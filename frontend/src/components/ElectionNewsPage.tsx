    ...
    <main className="min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <header className="mb-6 flex items-start justify-between gap-4">
          <h1 className="text-3xl font-bold tracking-normal text-slate-950 sm:text-5xl dark:text-white">
            Election News Summary
          </h1>
          <ThemeToggle />
        </header>

        <div className="sticky top-0 z-10 -mx-4 border-b border-slate-200 bg-slate-50/90 px-4 py-4 backdrop-blur sm:mx-0 sm:rounded-lg sm:border dark:border-line dark:bg-ink/90">
